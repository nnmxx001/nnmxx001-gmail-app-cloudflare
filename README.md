...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "nnmxx001-gmail-app-cloudflare-d1":

```bash
npx wrangler d1 create nnmxx001-gmail-app-cloudflare-d1
```
